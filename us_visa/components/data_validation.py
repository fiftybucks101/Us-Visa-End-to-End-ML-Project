...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            train_df, test_df = DataValidation.read_data(self.data_ingestion_config.training_data_file_path), DataValidation.read_data(self.data_ingestion_config.testing_data_file_path)
